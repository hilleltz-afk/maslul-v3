    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="grid gap-3">
          {projects.map((p) => (
            <div key={p.id} onClick={() => router.push(`/projects/${p.id}`)} className="bg-white rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow cursor-pointer flex items-center gap-4">
